...
* FREEZE (v1)
  - (DELIM removed in v1.1 for :op create): содержимое файла берётся как есть между begin/end.
...
- Состояние документа: ./doc-state-v1.org.
...
- Спецификация мода (основы и модули):
  ...
  - ./readme-v1.org — структура README.org, обязательные разделы и ссылки на спецификации.
