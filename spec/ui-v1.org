...
- Иконки для контролов модлайна:
  ...
  - Тумблер gptel-context [Ctx]: заменить иконку на material "link"; [Files] оставить текущую (например, material "description").
  - Suite/Engine как лейблы:
    - Формат отображения: ICON [value] при carriage-mode-use-icons=t и включённых переключателях; в текстовом фоллбэке — "Suite: [udiff]" и "Engine: [git]".
    - Новые переключатели:
