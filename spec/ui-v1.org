...
- Включение режима:
  ...
  - При наличии carriage-doc-state: восстановить параметры документа и скрыть служебные настройки (property drawer «Carriage State» или строки #+PROPERTY: CARRIAGE_*).
- Выключение режима:
